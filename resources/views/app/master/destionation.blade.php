                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form class="" action="tes" method="post" id="url_form">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Estimasi</label>
                                    <input type="text" class="form-control" name="estimate" id="estimate" placeholder="Estimasi" required>
                                </div>
                                <div class="form-group">
