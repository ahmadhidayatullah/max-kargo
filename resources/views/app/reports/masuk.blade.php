              ...
              <div class="card-header">
                <h4 class="card-title">
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <a href="{{route('reports.print',['type'=>'masuk','tanggal_mulai'=>$tanggal_mulai,'tanggal_sampai'=>$tanggal_sampai])}}" target="_blank" class="btn btn-default"><i class="ti-printer"></i> Print</a>
                    </div>
                  </div>
                </h4>
              </div>
              <div class="fresh-datatables table-responsive">
                <table id="datatables" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                  ...
                  <tfoot>
                    ...
                    <th colspan="2">{{toRupiah($total)}} </th>
