...
<div class="container">
    ...
    <div class="row">
        <div class="col">
            ...
            <form action="{{ route('user.update.task', $task->id) }}" method="post" style="display:inline">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                <button type="submit" class="btn btn-danger">Konfirmasi Sampai</button>
            </form>
            @endif
...
<script type="text/javascript">
    ...
    $(".btn-konfirmasi").click(function () {
        swal({
            title: 'Apakah kamu yakin orderan sudah sampai ?',
            type: 'warning',
